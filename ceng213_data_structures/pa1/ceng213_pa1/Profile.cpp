...
bool Profile::operator==(const Profile &rhs) const {/* TODO */
    return ((this->email == rhs.email) && (this->firstname == rhs.firstname) && (this->lastname == rhs.lastname));
}
...
bool Profile::operator<(const Profile &rhs) const {/* TODO */
    if (std::string(this->lastname) < std::string(rhs.lastname)){
        return true;
    }
    else if (std::string(this->lastname) == std::string(rhs.lastname)){
        if (std::string(this->firstname) < std::string(rhs.firstname)){
            return true;
        }
    }
    return false;
